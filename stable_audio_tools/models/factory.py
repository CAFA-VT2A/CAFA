...
def create_model_from_config(model_config):
    ...
    if model_type == "avclip_controlled_diffusion_cond":
        from .avclip_controlled_diffusion import (
            create_avclip_controlled_diffusion_cond_from_config,
        )

        return create_avclip_controlled_diffusion_cond_from_config(model_config)
    else:
